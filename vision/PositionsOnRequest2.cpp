...
#include "/home/pabbeel/code/master-slave/slaves/messaging.h"
#include "string.h"
...
int main(int argc, char** argv)
{
        ...
        {      
            ...
            while(1)
            {
                ...
                //cams.updateImages();
                Point3f p[2];  cams.getNewPoints(p, 2);   printf("Point 1: (%f, %f)    Point2: (%f, %f)     norm: %f \n", p[0].x, p[0].y, p[1].x, p[1].y, norm(p[1]-p[0]));
            }
            ...
            cams.getNewPoints(&pointFromCams, 1);
