...
function cams = readCamParamsFromCalibrationFunc(directory, calibDir)

%% cam1
load([directory '/' calibDir '/' 'calib1.mat']);
...
%% cam2
load([directory '/' calibDir '/' 'calib2.mat']);
...
%% cam3
load([directory '/' calibDir '/' 'calib3.mat']);
