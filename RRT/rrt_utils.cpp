...
//asumes thread has already been created
void generateRandomThread(ThreadConstrained* thread, double translation_offset_limit)
{
  ...
  //after this call, the thread won't be in a minimun energy configuration but in the configuration specified by material_frames
