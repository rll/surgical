...
#define BASENAME_INTERPOLATE_POINT_AND_LINEARIZE "interpolatePointsAndLinearize"
#define BASENAME_SQP_OPENLOOP "SQPOpenLoop"
#define BASENAME_SQP_CLOSEDLOOP "SQPClosedLoop"
#define BASENAME_RRT "RRT"
