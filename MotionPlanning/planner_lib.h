 ...
 */
void solveSQP(vector<Thread*>& traj_in, vector<Thread*>& traj_out, vector<VectorXd>& control_out, vector<Thread*>& sqp_debug_data, const char* namestring)
{
